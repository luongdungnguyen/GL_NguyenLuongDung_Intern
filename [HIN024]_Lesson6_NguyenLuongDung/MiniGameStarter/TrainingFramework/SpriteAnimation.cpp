...
SpriteAnimation::SpriteAnimation(std::shared_ptr<Model> model, std::shared_ptr<Shader> shader, std::shared_ptr<Texture> texture, GLint numFrames, GLfloat frameTime)
	: BaseObject()
{
	m_pModel = model;
	m_pShader = shader;
